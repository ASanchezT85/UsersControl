...
<header class="app-header app-header-dark">
    ...
    <div class="top-bar">
        ...
        <div class="top-bar-brand">
            <a href="{{ route('home') }}">
                <img src="{{ asset('png/brand-inverse.png') }}" alt="" style="height: 32px;width: auto;"></a>
        </div><!-- /.top-bar-brand -->
        <!-- .top-bar-list -->
                            ...
                            <div class="dropdown-scroll perfect-scrollbar">
                                ...
                                <a href="#" class="dropdown-item unread">
                                    <div class="user-avatar">
                                        <img src="{{ asset('avatars/uifaces15.jpg') }}" alt="">
                                    </div>
                                ...
                                <a href="#" class="dropdown-item unread">
                                    <div class="user-avatar">
                                        <img src="{{ asset('avatars/uifaces16.jpg') }}" alt="">
                                    </div>
                                    <div class="dropdown-item-body">
                                ...
                                <a href="#" class="dropdown-item">
                                    <div class="user-avatar">
                                        <img src="{{ asset('avatars/uifaces17.jpg') }}" alt="">
                                    </div>
                                    <div class="dropdown-item-body">
                                ...
                                <a href="#" class="dropdown-item">
                                    <div class="user-avatar">
                                        <img src="{{ asset('avatars/uifaces18.jpg') }}" alt="">
                                    </div>
                                    <div class="dropdown-item-body">
                                ...
                                <a href="#" class="dropdown-item">
                                    <div class="user-avatar">
                                        <img src="{{ asset('avatars/uifaces19.jpg') }}" alt="">
                                    </div>
                                    <div class="dropdown-item-body">
                                ...
                                <a href="#" class="dropdown-item">
                                    <div class="user-avatar">
                                        <img src="{{ asset('avatars/uifaces20.jpg') }}" alt="">
                                    </div>
                                    <div class="dropdown-item-body">
                                ...
                                <a href="#" class="dropdown-item">
                                    <div class="user-avatar">
                                        <img src="{{ asset('avatars/uifaces21.jpg') }}" alt="">
                                    </div>
                                    <div class="dropdown-item-body">
                    ...
                    <li class="nav-item dropdown header-nav-dropdown has-notified">
                        ...
                        <div class="dropdown-menu dropdown-menu-rich dropdown-menu-right">
                            ...
                            <div class="dropdown-scroll perfect-scrollbar">
                                ...
                                <a href="#" class="dropdown-item unread">
                                    <div class="user-avatar">
                                        <img src="{{ asset('avatars/team1.jpg') }}" alt="">
                                    </div>
                                    <div class="dropdown-item-body">

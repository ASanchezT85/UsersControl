...
var Theme = function () {
  function t() {
    ...
    _classCallCheck(this, t), this.colors = {
      ...
      white: "#ffffff"
    }, this.skins = ["default", "dark"], this.skin = localStorage.getItem("skin") || "default", $(document).ready(function () {
      e.init();
    });
  }
  ...
  return _createClass(t, [{
    ...
    value: function (e) {
      ...
      window.flatpickr && (flatpickr.defaultConfig.disableMobile = !0, $('[data-toggle="flatpickr"]').each(function () {
        var e = $(this).data();
        e.plugins = [], e.disable = e.disables || [], e.confirmdate && e.plugins.push(new confirmDatePlugin({
          showAlways: !0
        })), e.weekselect && e.plugins.push(new weekSelect({})), e.monthselect && e.plugins.push(new monthSelect({})), e.rangeplugin && e.plugins.push(new range({
...
/***/ 0:
/*!*****************************************!*\
  !*** multi ./resources/js/theme.min.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\Laravel\UsersControl\resources\js\theme.min.js */"./resources/js/theme.min.js");

...
$(document).ready(function () {
  ...
  function action(form) {
    ...
    $.ajax({
      ...
      error: function error(jqXHR, estado, _error) {
        $.each(jqXHR.responseJSON, function (indice, valor) {
          alertify.error(valor);
        });
      },
      complete: function complete(jqXHR, estado) {
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\Laravel\UsersControl\resources\js\app.js */"./resources/js/app.js");
